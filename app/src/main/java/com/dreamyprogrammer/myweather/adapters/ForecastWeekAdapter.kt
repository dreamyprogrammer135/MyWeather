...
class ForecastWeekAdapter : RecyclerView.Adapter<ForecastWeekAdapter.ViewHolder>() {

    private var forecastData: List<ForecastWeekWeather> = listOf()

    fun setData(data: List<ForecastWeekWeather>) {
        forecastData = data
    ...
    override fun onCreateViewHolder(
        ...
        return ViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_forecast_week, parent, false) as View
        )
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(forecast: ForecastWeekWeather) {
            itemView.findViewById<TextView>(R.id.day_text_view).text = forecast.date
