...
class WeatherLoader(
        ...
        try {
            ...
            Thread(Runnable {
                ...
                try {
                    ...
                    val jsonAdapter: JsonAdapter<WeatherFull> = moshi.adapter(
                        WeatherFull::class.java
                    )
                    val weatherYandex: WeatherFull =
                        jsonAdapter.fromJson(getLines(bufferedReader))!!

                    handler.post { listener.onLoaded(weatherYandex) }
                } catch (e: Exception) {
    ...
    interface WeatherLoaderListener {
        fun onLoaded(weatherFull: WeatherFull)
