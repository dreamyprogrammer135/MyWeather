...
fun getRussianCities(): List<Weather> {
    return listOf(
        ...
        Weather(
            Location("Санкт-Петербург", 59.9342802, 30.335098600000038),
            21,
            2.35,
            46,
            "пасмурно",
        ...
        Weather(
            Location("Новосибирск", 55.00835259999999, 82.93573270000002),
            25,
            1.35,
            41,
            "солнечно",
        ...
        Weather(
            Location("Екатеринбург", 56.83892609999999, 60.60570250000001),
            29,
            3.35,
            40,
            "солнечно",
